...
export default function Footer({ showCTA = false, showEasterEgg = false }: FooterProps) {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: 'https://www.linkedin.com/in/javierolan/?locale=es_ES',
    },
    {
      name: 'GitHub',
      icon: (
          ...
          {socialLinks.map((link, index) => (
            <MagneticButton key={index}>
              <motion.a
                ...
                className="w-14 h-14 rounded-full glass flex items-center justify-center text-text-primary hover:text-primary transition-colors duration-300 group"
