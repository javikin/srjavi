        ...
        <div className="rounded-xl bg-surface border border-white/5 p-6 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="usuario-u-organizacion"
              className={`${inputClasses} font-mono`}
            />
            <p className="text-xs text-text-muted">El usuario u organizacion de GitHub que posee el repositorio.</p>
          </div>
          ...
          {form.github_repo_owner && form.github_repo_name && (
            <div className="flex items-center gap-2 p-3 rounded-lg bg-mint/5 border border-mint/10">
              ...
              <span className="text-sm text-text-secondary">
                Se vinculara a{' '}
                <a
                  href={`https://github.com/${form.github_repo_owner}/${form.github_repo_name}`}
                  target="_blank"
