...
const NAV_ITEMS = [
  ...
  { href: '/admin/analytics', label: 'Analiticas', icon: 'chart' },
    ...
    <div className="flex min-h-screen">
      ...
      <aside className="w-64 bg-surface border-r border-white/5 flex flex-col">
        <div className="p-6 border-b border-white/5">
          ...
          <p className="text-sm text-text-muted">Panel de administracion</p>
        </div>
        ...
        <div className="p-4 border-t border-white/5">
          <Link
            href="/"
            className="flex items-center gap-2 px-3 py-2 text-sm text-text-muted hover:text-text-secondary transition-colors"
          >
