...
export default function RequestActions({
  ...
  if (hasGithubIssue || !hasGithubRepo) return null;
  ...
  return (
    <div className="rounded-xl bg-surface border border-white/5 p-6">
      ...
      <p className="text-sm text-text-muted mb-3">
        Esta solicitud no tiene un issue de GitHub vinculado. El repo esta configurado pero el issue no se creo automaticamente.
      </p>
      <button
      ...
      >
        ...
        {isPending ? 'Creando...' : 'Crear issue en GitHub'}
      </button>
    </div>
  );
}
